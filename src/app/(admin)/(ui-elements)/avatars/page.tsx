...
export const metadata: Metadata = {
  title: "Next.js Avatars | MiSkulAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for MiSkulAdmin - Next.js Tailwind CSS Admin Dashboard Template",
};
