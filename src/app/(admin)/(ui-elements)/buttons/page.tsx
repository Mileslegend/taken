...
export const metadata: Metadata = {
  title: "Next.js Buttons | MiSkulAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for MiSkulAdmin - Next.js Tailwind CSS Admin Dashboard Template",
};
